...
const STATS = [
  { value: '56%',    label: 'of Nepali diaspora send >20% of income as remittance', color: '#111111' },
  { value: '3×',     label: 'higher burnout risk for diaspora vs. non-remitters',    color: '#111111' },
  { value: '1 in 3', label: 'Nepali migrants report moderate-severe distress',       color: '#111111' },
]
